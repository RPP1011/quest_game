...
EXTRACT_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        ...
        # G13: unconscious motive resolutions. The LLM-side assessment of
        # when a motive resolves is still a stub (see TODO in extract stage);
        # this field wires the persistence path so a motive can be marked
        # resolved and the craft planner stops grounding indirection in it.
        "motive_resolutions": {
            "type": "array",
            "items": {
                "type": "object",
